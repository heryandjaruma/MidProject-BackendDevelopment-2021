...
<body>
    <div class="navbar shadow-sm p-3 rounded fixed-top" style="background-color: #EFF2F4;">
        <div>
    ...
    <footer class="footer mt-auto py-3 bg-light fixed-bottom">
        <div class="container" id="footercontent">
            <div>
                <span class="text-muted" id="content1">contact us &emsp; @hitchhiker.id</span>
                <img src="{{asset('sosmed.png')}}" alt="" id="sosmed">
            </div>
        </div>
    </footer>
</body>
